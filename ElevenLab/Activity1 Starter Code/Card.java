...
public class Card {
	 ...
	 *                       card
	 * @param cardPointValue an <code>int</code> value containing the point value of
	 *                       the card
	 */
	 ...
	 * printing the contents of a <code>Deck</code> in an easily readable format or
	 * performing other similar functions.
	 *
	 * @return a <code>String</code> containing the rank, suit, and point value of
	 *         the card.
	 */
	@Override
